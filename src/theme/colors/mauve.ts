...
export const mauve = defineSemanticTokens.colors({
	...
	solid: {
		bg: {
			...
			hover: {
				value: { _light: "{colors.mauve.12}", _dark: "{colors.mauve.12}" },
			},
		},
		fg: {
	...
	subtle: {
		bg: {
			DEFAULT: {
				value: { _light: "{colors.mauve.a3}", _dark: "{colors.mauve.a3}" },
			},
			hover: {
				value: { _light: "{colors.mauve.a4}", _dark: "{colors.mauve.a4}" },
			},
			active: {
				value: { _light: "{colors.mauve.a5}", _dark: "{colors.mauve.a5}" },
			},
		},
		fg: {
			DEFAULT: {
	...
	outline: {
		bg: {
			hover: {
				value: { _light: "{colors.mauve.a2}", _dark: "{colors.mauve.a2}" },
			},
			active: {
				value: { _light: "{colors.mauve.a3}", _dark: "{colors.mauve.a3}" },
			},
