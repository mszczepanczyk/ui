...
export const olive = defineSemanticTokens.colors({
	...
	solid: {
		bg: {
			...
			hover: {
				value: { _light: "{colors.olive.12}", _dark: "{colors.olive.12}" },
			},
		},
		fg: {
	...
	subtle: {
		bg: {
			DEFAULT: {
				value: { _light: "{colors.olive.a3}", _dark: "{colors.olive.a3}" },
			},
			hover: {
				value: { _light: "{colors.olive.a4}", _dark: "{colors.olive.a4}" },
			},
			active: {
				value: { _light: "{colors.olive.a5}", _dark: "{colors.olive.a5}" },
			},
		},
		fg: {
			DEFAULT: {
	...
	outline: {
		bg: {
			hover: {
				value: { _light: "{colors.olive.a2}", _dark: "{colors.olive.a2}" },
			},
			active: {
				value: { _light: "{colors.olive.a3}", _dark: "{colors.olive.a3}" },
			},
