...
export const sand = defineSemanticTokens.colors({
	...
	solid: {
		bg: {
			...
			hover: {
				value: { _light: "{colors.sand.12}", _dark: "{colors.sand.12}" },
			},
		},
		fg: {
	...
	subtle: {
		bg: {
			DEFAULT: {
				value: { _light: "{colors.sand.a3}", _dark: "{colors.sand.a3}" },
			},
			hover: {
				value: { _light: "{colors.sand.a4}", _dark: "{colors.sand.a4}" },
			},
			active: {
				value: { _light: "{colors.sand.a5}", _dark: "{colors.sand.a5}" },
			},
		},
		fg: {
			DEFAULT: {
	...
	surface: {
		bg: {
			DEFAULT: {
				value: { _light: "{colors.white}", _dark: "{colors.sand.1}" },
			},
			hover: { value: { _light: "{colors.sand.2}", _dark: "{colors.sand.2}" } },
			active: {
				value: { _light: "{colors.sand.3}", _dark: "{colors.sand.3}" },
			},
		},
		border: {
			DEFAULT: {
				value: { _light: "{colors.sand.6}", _dark: "{colors.sand.6}" },
			},
			hover: { value: { _light: "{colors.sand.7}", _dark: "{colors.sand.7}" } },
		},
		fg: {
			DEFAULT: {
				value: { _light: "{colors.sand.12}", _dark: "{colors.sand.12}" },
	...
	outline: {
		bg: {
			hover: {
				value: { _light: "{colors.sand.a2}", _dark: "{colors.sand.a2}" },
			},
			active: {
				value: { _light: "{colors.sand.a3}", _dark: "{colors.sand.a3}" },
			},
