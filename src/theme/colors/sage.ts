...
export const sage = defineSemanticTokens.colors({
	...
	solid: {
		bg: {
			...
			hover: {
				value: { _light: "{colors.sage.12}", _dark: "{colors.sage.12}" },
			},
		},
		fg: {
	...
	subtle: {
		bg: {
			DEFAULT: {
				value: { _light: "{colors.sage.a3}", _dark: "{colors.sage.a3}" },
			},
			hover: {
				value: { _light: "{colors.sage.a4}", _dark: "{colors.sage.a4}" },
			},
			active: {
				value: { _light: "{colors.sage.a5}", _dark: "{colors.sage.a5}" },
			},
		},
		fg: {
			DEFAULT: {
	...
	surface: {
		bg: {
			DEFAULT: {
				value: { _light: "{colors.white}", _dark: "{colors.sage.1}" },
			},
			hover: { value: { _light: "{colors.sage.2}", _dark: "{colors.sage.2}" } },
			active: {
				value: { _light: "{colors.sage.3}", _dark: "{colors.sage.3}" },
			},
		},
		border: {
			DEFAULT: {
				value: { _light: "{colors.sage.6}", _dark: "{colors.sage.6}" },
			},
			hover: { value: { _light: "{colors.sage.7}", _dark: "{colors.sage.7}" } },
		},
		fg: {
			DEFAULT: {
				value: { _light: "{colors.sage.12}", _dark: "{colors.sage.12}" },
	...
	outline: {
		bg: {
			hover: {
				value: { _light: "{colors.sage.a2}", _dark: "{colors.sage.a2}" },
			},
			active: {
				value: { _light: "{colors.sage.a3}", _dark: "{colors.sage.a3}" },
			},
